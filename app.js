...
Object.assign(translations, {
  "zh-TW": {
    ...
    "nav.how": "使用方式",
    "nav.faq": "常見問題",
    "action.downloadNow": "立即下載",
    "hero.kicker": "Windows · 本機/線上影片 · 輕量穩定",
    "hero.title": "把影片變成你的桌面",
    "hero.subtitle": "一鍵將本機或線上影片設為動態桌布。支援多語言、主題切換、音訊模式、自動輪播與收藏，讓桌面更有氛圍。",
    "hero.ctaPrimary": "下載 Windows 版",
    "hero.ctaSecondary": "查看功能",
    "hero.bullet1": "支援本機影片：mp4/avi/wmv/mkv",
    "hero.bullet2": "支援線上影片：可直接貼上 URL 或線上搜尋",
    "hero.bullet3": "隱藏桌面為可選項（預設關閉）",
    "features.title": "核心功能",
    "features.desc": "圍繞快速設定、穩定播放與可控體驗而設計。",
    "features.local.title": "本機影片動態桌布",
    "features.local.text": "選擇預設資料夾後自動掃描，清單中一鍵套用。",
    "features.online.title": "線上搜尋與播放",
    "features.online.text": "支援線上搜尋與連結播放，快速切換風格。",
    "features.desktop.title": "可控的桌面顯示",
    "features.desktop.text": "隱藏桌面是可選項：預設不生效，啟用後才會套用。",
    "features.ui.title": "主題與語言",
    "features.ui.text": "內建多主題與多語言介面，適應不同使用習慣。",
    "features.auto.title": "自動輪播與收藏",
    "features.auto.text": "支援定時自動切換桌布，收藏常用資源快速回到喜歡風格。",
    "how.title": "使用方式",
    "how.desc": "三步完成設定，桌面立刻動起來。",
    "how.step1.title": "選擇內容",
    "how.step1.text": "從本機影片清單選擇，或在網路影片中搜尋/貼上連結。",
    "how.step2.title": "一鍵套用桌面",
    "how.step2.text": "點擊「設定桌面」，播放器會在背景初始化並開始播放。",
    "how.step3.title": "依需求調整",
    "how.step3.text": "在設定頁調整音訊模式、自動輪播、隱藏桌面等選項。",
    "how.req.title": "系統需求",
    "how.req.text": "Windows 10/11 · 建議 iGPU/dGPU 皆可 · 大影片建議放在 SSD。",
    "faq.title": "常見問題",
    "faq.desc": "這裡整理了最常見的使用疑問。",
    "faq.q1": "「隱藏桌面」預設會啟用嗎？",
    "faq.a1": "不會。這是獨立選項且預設關閉，只有在設定中啟用後才會生效。",
    "faq.q2": "為什麼本機影片顯示找不到？",
    "faq.a2": "請確認路徑存在。file:/// 格式也會自動校驗。建議把影片放在預設影片資料夾。",
    "faq.q3": "退出後還有殘留視窗怎麼辦？",
    "faq.a3": "程式退出時會嘗試停止播放、還原桌面並關閉子視窗，並帶有兜底保護。",
    "faq.q4": "你們會上傳我的檔案嗎？",
    "faq.a4": "本機影片不會上傳。線上播放僅會向你選擇的來源發送必要請求。",
    "footer.brand": "RizzView",
    "footer.meta": "影片動態桌布",
    "footer.features": "功能",
    "footer.download": "下載",
  ...
  "de-DE": {
    ...
    "hero.kicker": "Windows · Lokale/Online-Videos · Leicht und stabil",
    ...
    "hero.bullet2": "Online-Videos: URL einfügen oder online suchen",
    "hero.bullet3": "Desktop ausblenden ist optional (standardmäßig aus)",
    "features.title": "Kernfunktionen",
    "features.desc": "Entwickelt für schnelle Einrichtung, stabile Wiedergabe und volle Kontrolle.",
    ...
    "features.online.text": "Suche online oder spiele direkt über Link für schnellen Stilwechsel.",
    "features.desktop.title": "Kontrollierte Desktop-Anzeige",
    "features.desktop.text": "Desktop ausblenden ist optional: standardmäßig aus und nur aktiv, wenn eingeschaltet.",
    "features.ui.title": "Designs und Sprachen",
    "features.ui.text": "Integrierte Designs und mehrsprachige UI für verschiedene Gewohnheiten.",
    "features.auto.title": "Auto-Wechsel und Favoriten",
    "features.auto.text": "Geplante Wallpaper-Rotation und Favoriten für schnellen Zugriff.",
    "how.title": "So funktioniert's",
    "how.desc": "In drei Schritten zu einem lebendigen Desktop.",
    "how.step1.title": "Inhalt wählen",
    "how.step1.text": "Wähle lokale Videos oder suche/füge einen Online-Link ein.",
    "how.step2.title": "Mit einem Klick anwenden",
    "how.step2.text": "Klicke auf „Desktop setzen“, der Player startet im Hintergrund.",
    ...
    "how.req.text": "Windows 10/11 · iGPU/dGPU unterstützt · SSD für große Videos empfohlen.",
    "faq.title": "FAQ",
    "faq.desc": "Antworten auf die häufigsten Fragen.",
    "faq.q1": "Ist „Desktop ausblenden“ standardmäßig aktiv?",
    "faq.a1": "Nein. Es ist eine separate Option und standardmäßig aus. Aktiv erst nach Einschalten in den Einstellungen.",
    "faq.q2": "Warum wird ein lokales Video als „nicht gefunden“ angezeigt?",
    "faq.a2": "Prüfe, ob der Pfad existiert. file:/// Pfade werden ebenfalls geprüft. Lege Videos am besten im Standardordner ab.",
    "faq.q3": "Was tun, wenn nach dem Beenden Fenster übrig bleiben?",
    "faq.a3": "Die App stoppt die Wiedergabe, stellt den Desktop wieder her und schließt Unterfenster inklusive Fallback-Schutz.",
    "faq.q4": "Werden meine Dateien hochgeladen?",
    "faq.a4": "Lokale Videos werden nicht hochgeladen. Online-Wiedergabe nutzt nur notwendige Anfragen zur gewählten Quelle.",
    "footer.brand": "RizzView",
    "footer.meta": "Video-Live-Wallpaper",
    "footer.features": "Funktionen",
    "footer.download": "Download",
  ...
  "fr-FR": {
    ...translations["fr-FR"],
    "brand.tag": "Fond d'écran vidéo animé",
    "nav.features": "Fonctionnalités",
    "nav.how": "Comment ça marche",
    "nav.faq": "FAQ",
    "action.downloadNow": "Télécharger",
    "hero.kicker": "Windows · Vidéos locales/en ligne · Léger et stable",
    "hero.title": "Transformez vos vidéos en bureau animé",
    "hero.subtitle": "Définissez des vidéos locales ou en ligne en fond animé en un clic. Multilingue, thèmes, modes audio, rotation auto et favoris.",
    "hero.ctaPrimary": "Télécharger pour Windows",
    "hero.ctaSecondary": "Voir les fonctionnalités",
    "hero.bullet1": "Vidéos locales : mp4/avi/wmv/mkv",
    "hero.bullet2": "Vidéos en ligne : collez une URL ou faites une recherche",
    "hero.bullet3": "Masquer le bureau est optionnel (désactivé par défaut)",
    "features.title": "Fonctionnalités clés",
    "features.desc": "Conçu pour une configuration rapide, une lecture stable et un contrôle total.",
    "features.local.title": "Fond animé avec vidéos locales",
    "features.local.text": "Après avoir choisi un dossier par défaut, le scan est automatique et l'application se fait en un clic.",
    ...
    "features.desktop.title": "Affichage du bureau maîtrisé",
    "features.desktop.text": "Masquer le bureau est optionnel : désactivé par défaut et actif uniquement si vous l'activez.",
    "features.ui.title": "Thèmes et langues",
    "features.ui.text": "Thèmes intégrés et interface multilingue pour différents usages.",
    "features.auto.title": "Rotation auto et favoris",
    "features.auto.text": "Planifiez la rotation du fond d'écran et enregistrez vos favoris.",
    "how.title": "Comment ça marche",
    "how.desc": "Trois étapes pour animer votre bureau.",
    "how.step1.title": "Choisir le contenu",
    "how.step1.text": "Choisissez des vidéos locales, ou recherchez/collez un lien en ligne.",
    "how.step2.title": "Appliquer en un clic",
    "how.step2.text": "Cliquez sur « Définir le bureau » et le lecteur démarre en arrière-plan.",
    "how.step3.title": "Ajuster selon vos besoins",
    "how.step3.text": "Réglez le mode audio, la rotation auto, le masquage du bureau et plus dans les paramètres.",
    "how.req.title": "Configuration requise",
    "how.req.text": "Windows 10/11 · iGPU/dGPU pris en charge · SSD recommandé pour les grosses vidéos.",
    "faq.title": "FAQ",
    "faq.desc": "Réponses aux questions les plus fréquentes.",
    "faq.q1": "« Masquer le bureau » est-il activé par défaut ?",
    "faq.a1": "Non. C'est une option séparée, désactivée par défaut. Elle ne s'applique qu'après activation dans les paramètres.",
    "faq.q2": "Pourquoi une vidéo locale affiche « introuvable » ?",
    "faq.a2": "Vérifiez que le chemin existe. Les chemins file:/// sont aussi validés. Placez les vidéos dans votre dossier vidéo par défaut.",
    "faq.q3": "Que faire si des fenêtres restent après fermeture ?",
    "faq.a3": "L'application tente d'arrêter la lecture, restaurer le bureau et fermer les sous-fenêtres, avec un mécanisme de secours.",
    "faq.q4": "Mes fichiers sont-ils envoyés ?",
    "faq.a4": "Les vidéos locales ne sont pas envoyées. La lecture en ligne dépend de la source choisie et n'effectue que les requêtes nécessaires.",
    "footer.brand": "RizzView",
    "footer.meta": "Fond d'écran vidéo animé",
    "footer.features": "Fonctionnalités",
    "footer.download": "Télécharger",
  ...
  "pt-PT": {
    ...translations["pt-PT"],
    "brand.tag": "Papel de parede em vídeo",
    "nav.features": "Funcionalidades",
    "nav.how": "Como funciona",
    "nav.faq": "FAQ",
    "action.downloadNow": "Transferir agora",
    "hero.kicker": "Windows · Vídeos locais/online · Leve e estável",
    "hero.title": "Transforme vídeos no seu ambiente de trabalho",
    "hero.subtitle": "Defina vídeos locais ou online como papel de parede animado com um clique. Multi-idioma, temas, modos de áudio, rotação automática e favoritos.",
    "hero.ctaPrimary": "Transferir para Windows",
    "hero.ctaSecondary": "Ver funcionalidades",
    "hero.bullet1": "Vídeos locais: mp4/avi/wmv/mkv",
    "hero.bullet2": "Vídeos online: cole um URL ou pesquise",
    "hero.bullet3": "Ocultar ambiente de trabalho é opcional (desativado por defeito)",
    "features.title": "Funcionalidades principais",
    "features.desc": "Concebido para configuração rápida, reprodução estável e controlo total.",
    "features.local.title": "Papel animado com vídeo local",
    "features.local.text": "Depois de escolher a pasta padrão, o sistema analisa automaticamente e aplica com um clique.",
    "features.online.title": "Pesquisa e reprodução online",
    ...
    "features.desktop.text": "Ocultar ambiente de trabalho é opcional: fica desativado por defeito e só funciona quando ativado.",
    "features.ui.title": "Temas e idiomas",
    "features.ui.text": "Temas integrados e interface multi-idioma para diferentes hábitos.",
    "features.auto.title": "Rotação automática e favoritos",
    "features.auto.text": "Agende a rotação do papel de parede e guarde os seus favoritos.",
    "how.title": "Como funciona",
    "how.desc": "Três passos para pôr o seu ambiente de trabalho em movimento.",
    "how.step1.title": "Escolher conteúdo",
    "how.step1.text": "Escolha vídeos locais ou pesquise/cole um link online.",
    ...
    "how.step3.title": "Ajustar conforme necessário",
    "how.step3.text": "Ajuste modo de áudio, rotação automática, ocultar ambiente e mais nas Definições.",
    "how.req.title": "Requisitos do sistema",
    "how.req.text": "Windows 10/11 · iGPU/dGPU suportado · SSD recomendado para vídeos grandes.",
    "faq.title": "FAQ",
    "faq.desc": "Respostas às perguntas mais frequentes.",
    "faq.q1": "\"Ocultar ambiente de trabalho\" está ativo por defeito?",
    "faq.a1": "Não. É uma opção separada e vem desativada por defeito. Só entra em vigor quando ativada nas Definições.",
    "faq.q2": "Porque um vídeo local aparece como \"não encontrado\"?",
    "faq.a2": "Confirme se o caminho existe. Caminhos file:/// também são validados. Coloque os vídeos na pasta de vídeo padrão.",
    "faq.q3": "E se ficarem janelas abertas após sair?",
    "faq.a3": "A aplicação tenta parar a reprodução, restaurar o ambiente de trabalho e fechar janelas-filhas, com proteção de fallback.",
    "faq.q4": "Vocês carregam os meus ficheiros?",
    "faq.a4": "Vídeos locais não são carregados. A reprodução online depende da fonte escolhida e faz apenas pedidos necessários.",
    "footer.brand": "RizzView",
    "footer.meta": "Papel de parede em vídeo",
    "footer.features": "Funcionalidades",
    "footer.download": "Transferir",
  ...
  "es-ES": {
    ...
    "hero.kicker": "Windows · Videos locales/online · Ligero y estable",
    "hero.title": "Convierte videos en tu escritorio",
    "hero.subtitle": "Configura videos locales u online como fondo animado con un clic. Multiidioma, temas, modos de audio, rotación automática y favoritos.",
    "hero.ctaPrimary": "Descargar para Windows",
    "hero.ctaSecondary": "Ver funciones",
    "hero.bullet1": "Videos locales: mp4/avi/wmv/mkv",
    "hero.bullet2": "Videos online: pega una URL o busca en línea",
    "hero.bullet3": "Ocultar escritorio es opcional (desactivado por defecto)",
    "features.title": "Funciones principales",
    "features.desc": "Diseñado para configuración rápida, reproducción estable y control total.",
    "features.local.title": "Fondo animado con video local",
    "features.local.text": "Tras elegir la carpeta predeterminada, escanea automáticamente y aplica con un clic.",
    "features.online.title": "Búsqueda y reproducción online",
    "features.online.text": "Busca en línea o reproduce por enlace para cambiar de estilo rápidamente.",
    "features.desktop.title": "Visibilidad del escritorio bajo control",
    "features.desktop.text": "Ocultar escritorio es opcional: está desactivado por defecto y solo funciona al activarlo.",
    "features.ui.title": "Temas e idiomas",
    "features.ui.text": "Temas integrados e interfaz multilingüe para distintos hábitos.",
    "features.auto.title": "Rotación automática y favoritos",
    "features.auto.text": "Programa la rotación del fondo y guarda tus favoritos.",
    ...
    "how.step3.title": "Ajustar según necesidad",
    "how.step3.text": "Ajusta modo de audio, rotación automática, ocultar escritorio y más en Configuración.",
    "how.req.title": "Requisitos del sistema",
    "how.req.text": "Windows 10/11 · Compatible con iGPU/dGPU · SSD recomendado para videos grandes.",
    "faq.title": "Preguntas frecuentes",
    "faq.desc": "Respuestas a las dudas más comunes.",
    "faq.q1": "¿\"Ocultar escritorio\" está activo por defecto?",
    "faq.a1": "No. Es una opción independiente y viene desactivada por defecto. Solo se aplica al activarla en Configuración.",
    "faq.q2": "¿Por qué un video local aparece como \"no encontrado\"?",
    "faq.a2": "Verifica que la ruta exista. Las rutas file:/// también se validan. Coloca los videos en tu carpeta predeterminada.",
    "faq.q3": "¿Qué pasa si quedan ventanas tras salir?",
    "faq.a3": "La app intenta detener la reproducción, restaurar el escritorio y cerrar subventanas, con protección de respaldo.",
    "faq.q4": "¿Suben mis archivos?",
    "faq.a4": "Los videos locales no se suben. La reproducción online depende de la fuente elegida y solo realiza solicitudes necesarias.",
    "footer.brand": "RizzView",
    "footer.meta": "Fondo de pantalla en video",
    "footer.features": "Funciones",
    "footer.download": "Descargar",
